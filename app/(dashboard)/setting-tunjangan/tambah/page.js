...
import {
  IconArrowLeft, IconCheck, IconX as IconClose
...
export default function TambahSettingTunjangan() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await api.post('/tunjangan/setting', payload);
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h2 className="text-xl font-bold" style={{ color: 'var(--text-primary)' }}>
            Tambah Setting Tunjangan
          </h2>
          <p className="text-sm mt-0.5" style={{ color: 'var(--text-muted)' }}>
            Buat aturan baru untuk tunjangan transport
          </p>
        </div>
      </div>
